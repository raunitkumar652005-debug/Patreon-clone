...
const Navbar = () => {
  ...
  return (
    <nav className='sticky top-0 left-0 w-full z-50 bg-gray-900 shadow-lg shadow-white text-white flex justify-between items-center px-4 py-3 md:px-6 md:py-4 flex-col md:flex-row gap-4 md:gap-0'>
